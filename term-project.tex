...
\reporttitle{Tree-Based Clustering for Ad Hoc Networks}
\coursename{CENG797 Special Topics in Computer Engineering: Ad Hoc Networks}
\courseterm{2025--2025 Fall}
\reportpurpose{Term Project Report}
\authorname{Murat Bolu}
\studentnumber{e2521300}
\useremail{murat.bolu@ceng.metu.edu.tr}
